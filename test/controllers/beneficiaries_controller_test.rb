...
class BeneficiariesControllerTest < ActionController::TestCase
  ...
  test "should create beneficiary" do
    assert_difference('Beneficiary.count') do
      post :create, beneficiary: { email: @beneficiary.email, first_name: @beneficiary.first_name, last_name: @beneficiary.last_name, phone: @beneficiary.phone, position: @beneficiary.position }
    end
  ...
  test "should update beneficiary" do
    patch :update, id: @beneficiary, beneficiary: { email: @beneficiary.email, first_name: @beneficiary.first_name, last_name: @beneficiary.last_name, phone: @beneficiary.phone, position: @beneficiary.position }
    assert_redirected_to beneficiary_path(assigns(:beneficiary))
  end
